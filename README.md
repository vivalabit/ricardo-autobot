...
- `/find <item> [price_or_range] [только доставка]` - parse live Ricardo.ch search results and return active listings. With a price/range or delivery-only phrase, Ricardo filters are applied.
